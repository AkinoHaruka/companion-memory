...
describe('native memory contracts', () => {
  it('rejects Dream endpoints that could disclose a credential in transit or in the URL', () => {
    const base = {
      ownerNamespace: 'riko', apiPath: '/memory/v1', apiToken: '', apiTokens: {}, dreamCredentialRef: 'DSH_MEMORY_DREAM_API_KEY', dreamModel: 'mimo-v2.5', dreamMaxTokens: 1200, dreamIntervalMs: 60_000, debounceMs: 0, maxResidentChars: 12_000, maxSessionChars: 40_000, demoEnabled: false,
    }
